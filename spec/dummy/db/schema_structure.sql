...
--
-- Name: accounts_created_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION accounts_created_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$        BEGIN
...
--
-- Name: accounts_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION accounts_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$        BEGIN
...
CREATE TRIGGER created_at BEFORE INSERT OR UPDATE ON accounts FOR EACH ROW EXECUTE PROCEDURE accounts_created_at();
...
CREATE TRIGGER updated_at BEFORE INSERT OR UPDATE ON accounts FOR EACH ROW EXECUTE PROCEDURE accounts_updated_at();


--
-- Name: accounts_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
INSERT INTO schema_info VALUES (18);